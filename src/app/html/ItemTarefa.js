export default function ItemTarefa({tarefaProp, handleDeleteTarefaProp, handleEditTarefaProp}) {
    return <li id={tarefaProp.id} key={tarefaProp.id} className="form-control mt-1">
        <div className="row">
